...
def process_video(video_path):
    ...
    8. **IMPORTANT** MAKE SURE THAT THE TIMESTAMP PROVIDED FOR EACH OBJECT IS THE LAST TIMEFRAME
    ...
    11. ****VERY IMPORTANT**** Do not include non-furniture objects like plants, books, or other items that are not furniture even if they are visual elements in the video.
    12. ***IMPORTANT*** SPECIFICALLY LOOK FOR Bed, Nightstand, Wardrobe, Desk, Chair, Door, Couch, Table, Bookshelf, Mini-fridge, Rug, Window, Bookshelf, Drawer 
    13. MAKE SURE THE OBJECTS ARE FULLY VISIBLE IN THE TIMESTAMP PROVIDED, IF THE OBJECT IS IN A TIMESTAMP BUT THE OBJECT IS NOT FULLY VISIBLE, DO NOT INCLUDE IT IN THAT TIMESTAMP AND MAKE A NEW ONE
    14. SPECIFICALLY MAKE SURE THAT THE WARDROBE IS FULLY VISIBLE IN THE TIMESTAMP PROVIDED, IF IT IS NOT, DO NOT INCLUDE IT IN THAT TIMESTAMP
    (FOR EXAMPLE, IF THE WARDROBE IS PARTIALLY VISIBLE AT 5 SECONDS BUT FULLY VISIBLE AT 7 SECONDS, DO NOT INCLUDE IT IN THE 5 SECONDS TIMESTAMP AND MAKE A NEW ONE FOR 7 SECONDS)
    """
    # temperature=0.2
    )
